...
def add_model_config_args(parser):
    ...
    group.add_argument('--num-attention-heads', type=int, default=NATT,
                       help='num of transformer attention heads')
    group.add_argument('--hidden-size', type=int, default=NHIDDEN,
                       help='tansformer hidden size')
    group.add_argument('--intermediate-size', type=int, default=None,
                       help='transformer embedding dimension for FFN'
                       'set to 4*`--hidden-size` if it is None')
    group.add_argument('--num-layers', type=int, default=NLAYERS,
                       help='num decoder layers')
    group.add_argument('--layernorm-epsilon', type=float, default=1e-5,
                       help='layer norm epsilon')
    group.add_argument('--hidden-dropout', type=float, default=0.1,
                       help='dropout probability for hidden state transformer')
    group.add_argument('--max-position-embeddings', type=int, default=MAX_POSITION_EMBEDDINGS,
                       help='maximum number of position embeddings to use')
    group.add_argument('--vocab-size', type=int, default=VOCAB_SIZE,
...
def add_training_args(parser):
    ...
    group.add_argument('--load', type=str, default=CHECKPOINT_PATH,
...
def add_evaluation_args(parser):
    ...
    group.add_argument('--eval-seq-length', type=int, default=MAXSEQLEN,
...
def add_text_generate_args(parser):
    ...
    group.add_argument("--temperature", type=float, default=TEMP)
    group.add_argument("--top_p", type=float, default=TOPP)
    group.add_argument("--top_k", type=int, default=TOPK)
    group.add_argument("--out-seq-length", type=int, default=OUT_SEQLEN)
...
def add_data_args(parser):
    ...
    group.add_argument('--tokenizer-path', type=str, default=TPATH,
    ...
    group.add_argument('--seq-length', type=int, default=MAXSEQLEN,
